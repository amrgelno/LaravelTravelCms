        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#static"  name='staticinfo' class=" dashboard   nav-link">
...
@endif
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div id='userinfo'>@yield('user')</div>
      <div id='Customize'>@yield('Customize') </div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="https://designwayseg.com/">DesignWays</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
...
<!-- AdminLTE App -->
<script src="{{asset('Front/JS/adminlte.min.js')}}" type="text/javascript"  ></script>
<!-- Themes -->
