...
@method('POST')
 ...
 <td><form  action="{{route('keywords.show',$keywordsitem->ID)}}"  method="get">
...
<input type="SUBMIT" name="SELECT_Keyword" style="margin: 5% 33%;
    ...
    background-image: url(../../../Front/ICON/R.png);" title='Editmarque' value>
     ...
     <td>
   <div align='center'> 
<form action="{{route('keywords.destroy',$keywordsitem->ID)}}" method="Post">
@csrf
@method('DELETE')
...
<form action="{{route('keywords.update',$keywordsitem->ID)}}" method="post" >
