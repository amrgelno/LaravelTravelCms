...
<head>
 ...
 <script src="https://cdn.tiny.cloud/1/2sv0zaptgw42b4r7hpylrp1qbzmflcka5uirblhujulbwpka/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
...
<script>
  ...
  <!-- <link rel="stylesheet" href="{{asset('Front/css/summernote-bs4.css') }}/">  -->
...
<label for="latitdue"> latitdue  </label> <input type='text' name='latitdue'   value='<?php echo $topicitem->latitdue;?>'>

<label for="longitude"> longitude  </label><input type='text' name='longitude'   value='<?php echo $topicitem->longitude;?>'>
...
<select name='Topic_STYLE'  id='Topic_STYLE' onchange='Location()'> 

    @if(isset($topicitem->Topic_style))

   <option   value="{{$topicitem->Topic_style}}"   align='center'>  Select TOPIC_STYLE </option> 

   <option value="Article">   @if(($topicitem->Topic_style)=='Article')  <span title='active'>o </span> Article  @else  Article  @endif </option> 

   <option value="AccordionPanel"> @if(($topicitem->Topic_style)=='AccordionPanel')<span title='active'>o </span>AccordionPanel @else   AccordionPanel  @endif  </option> 

   <option value="CollapseAccordionPanel"> @if(($topicitem->Topic_style)=='CollapseAccordionPanel')<span title='active'>o </span> AccordionPanel(Collapse_effect)   @else   AccordionPanel(Collapse_effect)  @endif  </option> 

   <option value="Accommodation cards"> @if(($topicitem->Topic_style)=='Accommodation cards')   <span title='active'>o </span>    Accommodation cards    @else   Accommodation cards    @endif  </option>

    <option value="Itinerary"  >  
	
	
@if(($topicitem->Topic_style)=='Itinerary') <span title='active'>o </span>  Itinerary  @else   Itinerary @endif 	
   ...
   <option value="CollapseAccordionPanel">  AccordionPanel(Collapse_effect)  </option>
    ...
    <option value="Accommodation cards " >  Accommodation cards  </option>
...
@endif
 ...
 <!-- <script src="{{asset('Front/JS/demo.js')}}" type="text/javascript"  defer></script>  -->
...
<script>
    ...
    function Location() {
		...
		const Topic_STYLE=document.querySelector('#Topic_STYLE').value;

if(Topic_STYLE=='Itinerary'){
