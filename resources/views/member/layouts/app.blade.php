...
<link href="{{asset('Front/css/bootstrap.min.css') }}" rel="stylesheet"></head></head>
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('member.Login') }}">{{ __('member Login') }}</a>
                                </li>
                            @endif

                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('member.register') }}">{{ __('member Register') }}</a>
                                </li>
                            @endif
                        @else
