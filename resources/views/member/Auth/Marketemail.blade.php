...
<input type="hidden" name="profile_IMG" value="{{auth::guard('member')->user()->prof_pic }}">



<input type="hidden" name="sender_id" value="{{auth::guard('member')->user()->id }}">


<input type="hidden" name="recevier_id" value="0">
...
<img src="../Front/IMG/{{$orders_item -> profile_IMG}}" class="img"/>  
