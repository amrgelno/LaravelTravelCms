...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#Marketemail"  class="Marketemail nav-link active">
             ...
             <p>Marketemail</p>  
              ...
              <li class="nav-item">
                <a href="#ProfileSetting"  name='projects' class="projects nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ProfileSetting</p>
                </a>
              </li>
            ...
            <!--  <li class="nav-item">
                <a href="#FavAds"  name='Clients' class="Clients nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>FavAds</p>
                </a>
              </li>  -->
  ...
  <div id='Marketemail'> @yield('Marketemail') </div>

  <div id='ProfileSetting'> @yield('ProfileSetting') </div>



  <div id='FavAds'> @yield('FavAds') </div>
