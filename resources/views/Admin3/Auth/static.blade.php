...
<input class="lang-option" data-lang="en" type="text" name="statictitle"  placeholder='En-title' value="<?php echo $SNumbersitem->title;?>" />

<input class="lang-option" data-lang="ar" style="display:none;" type="text" name="Ar_title"    placeholder='Ar-title'   value="<?php echo $SNumbersitem->Ar_title;?>" />

<input class="lang-option" data-lang="fr" style="display:none;" type="text" name="Fr_title"    placeholder='Fr-title'   value="<?php echo $SNumbersitem->Fr_title;?>" />
