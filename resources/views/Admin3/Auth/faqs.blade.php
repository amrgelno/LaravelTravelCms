...
<div id="EnLangoption" class="lang-option" data-lang="en">
    ...
    <br /> 
    <br />
    <textarea  cols='60' row='30'  name='content'  >{{ $faqitem-> Answer }}</textarea>
    <br />
</div>
...
<div id="ArLangoption" class="lang-option" data-lang="ar" style="display:none;">
    ...
    <br />
    <br />
    <textarea  cols='60' row='30'   name='Ar_content'  > {{ $faqitem->Ar_Answer }} </textarea>
    <br />
</div>
...
<div id="FrLangoption" class="lang-option" data-lang="fr" style="display:none;">
    ...
    <input type="text"   value="{{ $faqitem->Fr_Question }}"   class='faqs-input'  style='width:750px;' name="Fr_subject"  placeholder="newsubject" />
    <br />
    <br />
    <textarea  cols='60' row='30'   name='Fr_content'  > {{ $faqitem->Fr_Answer }} </textarea>
    <br />
</div>
