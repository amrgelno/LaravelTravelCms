...
<B style='color:blue'> headline color: </B>

<Label> H1 color </Label>

<input type="color"  name="H1color"/>

<Label> H2 color </Label>

<input type="color"  name="H2color"/>

<Label> H3 color </Label>

<input type="color"  name="H3color"/>

<Label> H4 color </Label>

<input type="color"  name="H4color"/>

<Label> H5 color </Label>

<input type="color"  name="H5color"/>


<br/> <br/>


<B style='color:blue'> Link color: </B>

<Label> Link Hover color </Label>

<input type="color"  name="Link_Hover"/>
...
<B style='color:blue'> Footer: </B>

<Label> Footer BGcolor </Label>

<input type="color"  name="FBGcolor"/>

<Label> Footer Fontcolor </Label>

<input type="color"  name="FFcolor"/>
...
<labeL>H1_Color: </labeL> {{$viewitem->H1_Color}}   <br/>
<labeL>H2_Color: </labeL> {{$viewitem->H2_Color}}   <br/>
<labeL>H3_Color: </labeL> {{$viewitem->H3_Color}}   <br/>
<labeL>H4_Color: </labeL> {{$viewitem->H4_Color}}   <br/>
<labeL>H5_Color: </labeL> {{$viewitem->H5_Color}}   <br/>
<labeL>Link Hover: </labeL> {{$viewitem->Link_Hover}}   <br/>
