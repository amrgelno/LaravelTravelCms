...
<head>
   ...
   <link href="http://{{$Domain_site}}/Front/css/adminlte.css" rel="stylesheet" type="text/css"/>
   <link href="http://{{$Domain_site}}/Front/css/adminlte.min.css" rel="stylesheet" type="text/css"/>
   <link href="http://{{$Domain_site}}/Front/css/all.min.css" rel="stylesheet" type="text/css"/>
...
<h1 style = "margin-left: 10px;">General Analysis </h1>
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Indexed_Link:</span>
                <span class="info-box-number">{{$nav}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{$Keyword}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<h1 style = "margin-left: 10px;" >   Web Visitor / Client Analysis </h1>
...
<div class="col-md-12">
    ...
    <div class="card-tools">
        <button id = "minimize-button" type="button" class="btn btn-tool" data-card-widget="collapse">
        ...
        <circle cx="1798.2" cy="719.3" id="2">
                ...
                <div class="col-md-4">
                    ...
                    <div class="progress-group">
                        Visitor :
                        <span class="float-right"><b>{{$countvisitor}}</b></span>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-primary" style="width:{{(($countvisitor)/(500))*(100)}}%;"></div>
                        </div>
                    </div>

                    <div class="progress-group">
                        Visitedlink :
                        <span class="float-right"><b>{{$countvlink}}</b></span>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-danger" style="width: {{(($countvlink)/(200))*(100)}}%;"></div>
                        </div>
                    </div>

                    <div class="progress-group">
                        <span class="progress-text">Client</span>
                        <span class="float-right"><b>{{$client}}</b></span>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-success" style="width: {{(($client)/(200))*(100)}}%;"></div>
                        </div>
                    </div>

                    <div class="progress-group">
                          Clientrequest
                        <span class="float-right"><b>{{$client_req}} </b></span>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-warning" style="width: {{(($client_req)/(200))*(100)}}%;"></div>
                        </div>
                    </div>

                    <div class="progress-group">
                          Member
                        <span class="float-right"><b>{{ $countmember}} </b></span>
                        <div class="progress progress-sm">
                            <div class="progress-bar bg-warning" style="width: {{(($countmember)/(200))*(100)}}%;"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                        ...
                        <span class="description-text">TOTAL world</span>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                        ...
                        <span class="description-text">Out Side Egypt</span>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-6">
                    <div class="description-block border-right">
                        ...
                        <span class="description-text">Egypt</span>
                    </div>
                </div>
                ...
                <div class="col-sm-3 col-6">
                    <div class="description-block">
                        ...
                        <span class="description-text">Middel East</span>
                    </div>
                </div>
            </div>
        </div>
...
<h1 style = "margin-left: 10px;" > Web Visitor Report  </h1>
...
<div class="card">
            ...
            <table class="table m-0">
                ...
                @foreach(  $visitors  as  $visitor)
                    ...
                    <tr>
                        ...
                        <td><span class="badge badge-success">{{$visitor->IP_Address}}</span></td>
                        <td> <a href='{{$visitor->vlink}}' style='color:white'> {{$visitor->vlink}} </a></td>
                        <td> {{$visitor->country}}    </td>
                        <td> {{$visitor->Devices}}    </td>   
                        <td>
                            <div class="sparkbar" data-color="#00a65a" data-height="20">{{$visitor->time}}</div>
                        </td>
                    </tr>
                    @endforeach
    ...
    <div class="card-footer clearfix">
        <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">View All Orders</a>
    </div>
</div>
...
<h1 style = "margin-left: 10px;" >leads search Queries    </h1>
...
<script src="{{asset('Front/JS/dashboard2.js') }}"  type="text/javascript"  defer></script>
<script src="{{asset('Front/JS/jquery.overlayScrollbars.min.js') }}"  type="text/javascript"  defer></script>
<script src="{{asset('Front/JS/world.js') }}"  type="text/javascript"  defer></script>
<script src="{{asset('Front/JS/adminlte.js') }}"  type="text/javascript"  defer></script>
