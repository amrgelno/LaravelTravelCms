...
.massage {
    ...
    height: 180px;
    text-align: center;
    margin: 485px 179px 11px 52px;
    padding: 82px 20px 30px 105px;
    font-size: 30px;
    color: #FFC107;
    border: 2px solid #000;
    background: #607D8B;
